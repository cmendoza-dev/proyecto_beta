...
<div class="max-w-3xl mx-auto">
    <div class="mb-6">
        <a href="{{ route('participants.index') }}" class="inline-flex items-center text-sm font-medium text-gray-600 hover:text-gray-900">
    ...
    <div class="overflow-hidden bg-white rounded-lg shadow">
        ...
        >
            ...
            <div class="space-y-6">
                <!-- Mensaje de RENIEC -->
                <div x-show="reniecMessage" x-transition class="p-4 rounded-lg" :class="{
                ...
                <div>
                    ...
                    <div class="flex space-x-2">
                        ...
                        @if(!isset($participant))
                            ...
                            >
                                <svg x-show="searchingReniec" class="animate-spin -ml-1 mr-2 h-4 w-4 text-white" fill="none" viewBox="0 0 24 24">
                ...
                <div>
                    ...
                    <p class="mt-1 ml-6 text-sm text-gray-500">Los participantes inactivos no podrán registrar asistencia</p>
                </div>
            </div>
        ...
        <div class="flex">
            ...
            <div class="ml-3">
                ...
                <p class="mt-1 text-sm text-blue-700">
                    Si la API no responde, puede ingresar los datos manualmente. Los datos se autocompletarán si se encuentran en RENIEC.
                </p>
            </div>
        </div>
    </div>
