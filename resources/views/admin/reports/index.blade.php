    ...
    <div class="p-6 bg-white rounded-lg shadow">
        <form method="GET" action="{{ route('admin.reports.index') }}" class="grid grid-cols-1 gap-4 md:grid-cols-5">
            ...
            <div class="flex items-end space-x-2">
                ...
                <a href="{{ route('admin.reports.index') }}" class="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-200 rounded-lg hover:bg-gray-300">
                    Limpiar
                </a>
            </div>
        </form>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm font-semibold text-gray-900">{{ $meeting->attendances_count ?? 0 }}</span>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                            <div class="flex items-center justify-end space-x-2">
                                <a href="{{ route('meetings.show', $meeting) }}" class="text-blue-600 hover:text-blue-900" title="Ver detalles">
                                ...
                                @if($meeting->attendances_count > 0)
                                    <a href="{{ route('meetings.report', $meeting) }}" class="text-purple-600 hover:text-purple-900" title="Descargar PDF">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
