                    ...
                    @if (isset($recentMeetings) && $recentMeetings->count() > 0)
                        <div class="space-y-3">
                            @foreach ($recentMeetings as $meeting)
                                <div class="flex items-center justify-between p-4 rounded-lg bg-gray-50 shadow">
                                    <div class="flex-1">
                                        <h4 class="font-medium text-gray-900">{{ $meeting->title }}</h4>
                                        <p class="text-sm text-gray-600">{{ $meeting->date->format('d/m/Y') }} -
                                            {{ \Carbon\Carbon::parse($meeting->opening_time)->format('g:i A') }}</p>
                                    </div>
                                    <div class="mt-2 text-sm text-gray-700">
                                        <span class="font-medium">Asistentes:</span>
