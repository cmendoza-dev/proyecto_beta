            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            id="opening_time"
                            name="opening_time"
                            value="{{ old('opening_time', $meeting->opening_time ?? '') }}"
                            required
                    ...
                    <div>
                        ...
                        <input
                            ...
                            id="closing_time"
                            name="closing_time"
                            value="{{ old('closing_time', $meeting->closing_time ?? '') }}"
                            required
                ...
                @if(isset($meeting))
                    <div>
                        ...
                        >
                            <option value="draft" {{ old('status', $meeting->status) === 'draft' ? 'selected' : '' }}>Borrador</option>
                            <option value="open" {{ old('status', $meeting->status) === 'open' ? 'selected' : '' }}>Abierta</option>
                            <option value="closed" {{ old('status', $meeting->status) === 'closed' ? 'selected' : '' }}>Cerrada</option>
                        </select>
